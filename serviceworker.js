...
self.addEventListener("install", (e) => {
  ...
  //const contentToCache = ['/miniflux_offline_client/unread/index.html', '/miniflux_offline_client/unread/styles.css', '/favicon.png']; // Array of URLs to cache. Will add all static content when released.
